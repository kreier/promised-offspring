# Create a pdf document for the lineage from Adam to Jesus
...
color_scheme = "normal"
mm           = 2.834645669                # document is in pt, 85 rows with 14pt height, text 10pt
border_lr    = 5*mm                       # space left/right 
border_tb    = 5*mm
